...
export async function GET(
  ...
  try {
    // Tenancy por account_id (igual que el motor: loadActiveRunsForAccount
    // filtra por account_id, no por user_id). Filtrar por user_id aquí
    // rompe la lectura para compañeros de cuenta (404 fantasma).
