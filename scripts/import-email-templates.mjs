...
const LOGO_URL = 'https://allon4dentalcenter.com/logo-a4-dark.png'
const COORDINATOR_NAME = 'Daniel'
const COORDINATOR_EMAIL = 'hello@allon4dentalcenter.com'
const CLINIC_ADDRESS =
  'Col. Luis Donaldo Colosio SM 310 Mz 1 Lote 4, Residencial Cumbres, Canc&uacute;n, Quintana Roo 77560, M&eacute;xico'
