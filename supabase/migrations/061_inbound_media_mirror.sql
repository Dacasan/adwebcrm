-- ============================================================
-- 061_inbound_media_mirror
--
-- PROCEDENCIA: viene de upstream (ArnasDon/wacrm) como 039. Renumerada al
-- fusionar: este fork ya tenía su propia 039 (calls). Añade columnas a
-- `messages` y a `whatsapp_config`; ninguna de las migraciones 040-058 de
-- este fork define esas columnas, así que aplicarla al final no choca.
--
