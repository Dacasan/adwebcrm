-- ============================================================
-- 059_webhook_broadcast_reliability
--
-- PROCEDENCIA: viene de upstream (ArnasDon/wacrm) como 037. Renumerada al
-- fusionar: este fork ya tenía su propia 037 (harden_function_grants), y dos
-- archivos con el mismo número se aplican en orden indeterminado — una
-- colisión que git no ve, porque los nombres difieren y fusiona ambos sin
-- avisar. Sus hermanas son la 060 y la 061, en el mismo orden relativo que
-- traían. Correr después de las nuestras es seguro: es aditiva y no toca
-- ningún objeto que toquen las migraciones 037-058 de este fork.
--
