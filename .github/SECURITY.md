...
- [GitHub Security Advisories](https://github.com/Dacasan/adwebcrm/security/advisories/new)
...
In scope:
- Anything in this repository (`Dacasan/adwebcrm`), including webhook and auth
